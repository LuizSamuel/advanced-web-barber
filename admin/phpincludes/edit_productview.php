...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE products SET name='$name', description='$description', cost='$cost' WHERE id=$product_id";
    ...
    if ($connection->query($sql) === TRUE) {
        ...
        if ($_FILES['image']['size'] > 0) {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                ...
                $sql = "UPDATE products SET image_path='$target_file' WHERE id=$product_id";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <a href="../viewproduct.php" class="btn btn-warning" style="border-radius: 3px; background-color: silver; display: inline-block; padding: 1.5px 5px; text-decoration: none; color: black;">Cancel</a>
